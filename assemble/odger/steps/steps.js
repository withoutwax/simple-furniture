function initialize(step) {
    ...
    switch (step) {
        case 1:
            ...
            document.getElementsByClassName("background-blur").style.backgroundImage = 'url("../../assets/images/odger/odger_step_01_10.jpg")';
...
function updateSteps(step) {
    switch (step) {
        case 2:
            ...
            document.getElementsByClassName("background-blur").style.backgroundImage = 'url("../../assets/images/odger/odger_step_02_10.jpg")';
